    ...
    >
      <AnimatePresence initial={false}>
        ...
        >
          ...
          {showHandlebar && (
            <div className="h-5 w-5 rounded-md top-1/2 -translate-y-1/2 bg-primary-foreground z-30 -right-2.5 absolute flex items-center justify-center shadow-[0px_-1px_0px_0px_oklch(var(--primary-foreground)/0.25)]">
              <IconDotsVertical className="h-4 w-4 text-primary" />
            </div>
          )}
        </motion.div>
      </AnimatePresence>
